import React, { forwardRef, useState, useEffect, type HTMLAttributes } from 'react';

let warned = false;

export const Div100vh = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ style, ...other }, ref) => {
